...
import { TaskStatus as TaskStatusComponent, TaskPriority as TaskPriorityComponent } from '@/components/task'
import type {
  Project,
  Task,
  TaskPriority,
...
export function ProjectDetailPage() {
  ...
  return (
    <PageContainer size="standard">
      {/* Editorial Page Header with Breadcrumbs */}
      <PageHeader
        breadcrumbs={[
                ...
                {members
                  ...
                  .map((member) => {
                    ...
                    return (
                      ...
                      >
                        <HStack spacing={3}>
                          <Avatar size="xs" name={member.user.username} bg="brand.primary" color="ink.inverse" />
                          <Box>
                            <HStack spacing={1.5}>
                              <Text fontSize="xs" fontWeight="600" color="ink.primary">
                      ...
                      <Stack spacing={4}>
                        ...
                        <SimpleGrid columns={2} spacing={4} fontSize="xs">
                          ...
                          <Box>
                            ...
                            <Text color="ink.primary" fontWeight="600" fontFamily="mono" mt={1}>
